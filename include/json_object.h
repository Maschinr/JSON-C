...
extern int json_object_add_string(json_object* object, const char* name, char* value);
extern int json_object_insert_string(json_object* object, const char* name, char* value);
extern int json_object_change_string(json_object* object, const char* name, char* value); 

extern int json_object_get_number(const json_object* object, const char* name, int* result);
extern int json_object_add_number(json_object* object, const char* name, int value);
extern int json_object_insert_number(json_object* object, const char* name, int value);
extern int json_object_change_number(json_object* object, const char* name, int value); 

extern int json_object_get_float_number(const json_object* object, const char* name, double* result);
extern int json_object_add_float_number(json_object* object, const char* name, double value);
extern int json_object_insert_float_number(json_object* object, const char* name, double value);
extern int json_object_change_float_number(json_object* object, const char* name, double value);

extern int json_object_get_object(const json_object* object, const char* name, json_object** result);
extern int json_object_add_object(json_object* object, const char* name, json_object* value);
extern int json_object_insert_object(json_object* object, const char* name, json_object* value);

extern int json_object_get_array(const json_object* object, const char* name, json_array** result);
extern int json_object_add_array(json_object* object, const char* name, json_array* value);
extern int json_object_insert_array(json_object* object, const char* name, json_array* value);
